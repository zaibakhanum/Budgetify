function CalendarApp(date) {
    ...
    this.quotes = ['Chillax! i am here to remind you ☺', 'Work hard, success will find its way to you', 'Happy to help you ☺'];
    this.apts = [
      {
    ...
    this.aptDates = [new Date(2021, 4, 30).toString(),new Date(2021, 4, 1).toString()];
    this.eles = {
    };
